...
<template>
  <div class="webinars-container">
    ...
    <div class="webinars-container__cards">
      <WebinarsCard :webinar-item="webinarCard" />
      <WebinarsCard :webinar-item="webinarCard" />
      <WebinarsCard :webinar-item="webinarCard" />
      <WebinarsCard :webinar-item="webinarCard" />
    </div>
